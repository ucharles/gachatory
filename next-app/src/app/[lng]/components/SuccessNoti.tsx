...
export default function SuccessNoti({
  ...
  return (
    ...
    >
      <div
        className="mb-4 flex items-center rounded-lg border border-green-300 bg-green-50 p-4 text-base text-green-800 dark:border-green-800 dark:bg-gray-800 dark:text-green-400"
        role="alert"
      >
        <svg
